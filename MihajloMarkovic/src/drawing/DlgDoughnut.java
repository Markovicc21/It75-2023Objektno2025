...
public class DlgDoughnut extends JDialog{
    ...
    public DlgDoughnut() {
        ...
        gbl_contentPanel.rowHeights = new int[]{35, 35, 35, 35, 0, 0, 0};
        ...
        gbc_lblInnerRadius.fill = GridBagConstraints.BOTH;
				...
				if (txtX.getText().isEmpty() || txtY.getText().isEmpty() || txtRadius.getText().isEmpty() || 
		                    ...
		                    try {
		                        ...
		                        if (radius <= 0 || innerRadius <= 0) {
		                            JOptionPane.showMessageDialog(null, "Radius and inner radius must be positive.", "ERROR",
		                                    JOptionPane.ERROR_MESSAGE);
		                        } else if (innerRadius >= radius) {
		                            JOptionPane.showMessageDialog(null, "Inner radius must be smaller than the outer radius.", "ERROR",
		                                    JOptionPane.ERROR_MESSAGE);
		                        } else {
		                            confirmation = true;
		                            setVisible(false);
